...
SRC_URI="https://download.gnome.org/sources/libxml2/2.15/libxml2-2.15.4.tar.xz -> libxml2-2.15.4.tar.xz"
SLOT="2"
KEYWORDS="*"
IUSE="+icu +lzma readline static-libs"
RDEPEND="=dev-libs/libxml2-2.15.4:=[lzma?,icu?,readline?,static-libs?]
